...
complete -c clove -f
set -l clove_cmds status stats list watch top show add remove pause resume start verify priorities announce sequential seed-ratio peer completions
...
# usefully offer.
complete -c clove -n '__fish_seen_subcommand_from remove pause resume start verify announce' -l all
